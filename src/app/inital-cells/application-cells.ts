...
export const NGVAULT_CELLS = [
  provideFeatureCell(UserCellNoCacheService, { key: 'userNoCache', initial: initialUsers }),
  provideFeatureCell(UserCellManualService, { key: 'userManual', initial: initialUsers }),
